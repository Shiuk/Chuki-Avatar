...
float4 frag(v2f i, uint facing: SV_IsFrontFace): SV_Target
{
	...
	**********************************************************************/
		...
		#ifdef POI_SPECULAR
			meta.SpecularColor = poiLight.color.rgb * float4(0.01096008,0.3231432,0.04817181,1).rgb * lerp(1, albedo.rgb, float(0.78)) * float4(0.01096008,0.3231432,0.04817181,1).a;
		#else
