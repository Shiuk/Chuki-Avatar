Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/24e1252fd07f78d4c8676e002ac36230"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				reflections = surfaceReduction * reflCol * lerp(1, FresnelLerp(specCol, grazingTerm, poiLight.nDotV), (1.0 /*_RefSpecFresnel*/));
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float specularMask = 1;
				#if defined(PROP_CLEARCOATMAPS) || !defined(OPTIMIZER_ENABLED)
				float4 PRBMaps = POI2D_SAMPLER_PAN(_ClearCoatMaps, _MainTex, poiUV(poiMesh.uv[(0.0 /*_ClearCoatMapsUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				clearCoatMask *= PRBMaps.r;
				smoothness *= PRBMaps.g;
				reflectionMask *= PRBMaps.b;
				specularMask *= PRBMaps.a;
				#endif
				specularMask *= (0.178 /*_ClearCoatSpecularStrength*/);
				reflectionMask *= (0.558 /*_ClearCoatReflectionStrength*/);
				...
				{
					percepRough = GSAA_Filament(poiMesh.normals[1], percepRough, (0.15 /*_ClearCoatGSAAVariance*/), (0.1 /*_ClearCoatGSAAThreshold*/));
				}
				float brdfRoughness = percepRough * percepRough;
				brdfRoughness = max(brdfRoughness, 0.002);
				float3 diffuse = 0;
				...
				float surfaceReduction = (1.0 / (brdfRoughness * brdfRoughness + 1.0));
				float grazingTerm = saturate(smoothness + (1 - omr));
				float3 reflCol = GetReflections(poiCam, poiLight, poiMesh, roughness, (0.0 /*_ClearCoatForceFallback*/), (1.0 /*_ClearCoatLitFallback*/), _ClearCoatFallback, poiCam.vertexReflectionDir);
			...
			void stylizedSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					specMask1 += pow(specArea, exp2(lerp(11, 1, (0.393 /*_HighColor_Power*/)))) * (1.0 /*_Layer1Strength*/);
					specMask2 += pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.133 /*_Layer2Strength*/);
				}
				else
				{
					specMask1 += poiEdgeNonLinear(specArea, (1.0 - pow((0.393 /*_HighColor_Power*/), 5)), (0.0 /*_StylizedSpecularFeather*/)) * (1.0 /*_Layer1Strength*/);
					specMask2 += poiEdgeNonLinear(specArea, (1.0 - pow((0.0 /*_Layer2Size*/), 5)), (0.0 /*_StylizedSpecular2Feather*/)) * (0.133 /*_Layer2Strength*/);
				}
				#if defined(PROP_SET_HIGHCOLORMASK) || !defined(OPTIMIZER_ENABLED)
				float specularMask = POI2D_SAMPLER_PAN(_Set_HighColorMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_Set_HighColorMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).g;
				#else
				float specularMask = 1;
				#endif
				...
				float attenuation = min(poiLight.nDotLSaturated, lerp(poiLight.attenuation, 1, (1.0 /*_SSIgnoreCastedShadows*/)));
				...
				for (int index = 0; index < 4; index++)
				{
					...
					if ((0.0 /*_Is_SpecularToHighColor*/))
					{
						vSpecMask = pow(specArea, exp2(lerp(11, 1, (0.393 /*_HighColor_Power*/)))) * (1.0 /*_Layer1Strength*/) * poiLight.vAttenuation * poiLight.vColor[index];
						vSpecMask = max(vSpecMask, pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.133 /*_Layer2Strength*/) * poiLight.vAttenuation * poiLight.vColor[index]);
					}
					else
					{
						vSpecMask = poiEdgeNonLinear(specArea, (1.0 - pow((0.393 /*_HighColor_Power*/), 5)), (0.0 /*_StylizedSpecularFeather*/)) * (1.0 /*_Layer1Strength*/) * poiLight.vAttenuation * poiLight.vColor[index];
						vSpecMask = max(vSpecMask, poiEdgeNonLinear(specArea, (1.0 - pow((0.0 /*_Layer2Size*/), 5)), (0.0 /*_StylizedSpecular2Feather*/)) * (0.133 /*_Layer2Strength*/) * poiLight.vAttenuation * poiLight.vColor[index]);
					}
				}
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.07843138).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.07843138).a;
