Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/b3998fee17f45834381f0d3681e68e73"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float smoothness = (0.903 /*_MochieRoughnessMultiplier*/);
			...
			void stylizedSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					specMask1 += pow(specArea, exp2(lerp(11, 1, (0.234 /*_HighColor_Power*/)))) * (1.0 /*_Layer1Strength*/);
					specMask2 += pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.133 /*_Layer2Strength*/);
				}
				else
				{
					specMask1 += poiEdgeNonLinear(specArea, (1.0 - pow((0.234 /*_HighColor_Power*/), 5)), (0.0 /*_StylizedSpecularFeather*/)) * (1.0 /*_Layer1Strength*/);
				...
				#ifdef POI_PASS_ADD
				attenuation *= lerp(poiLight.additiveShadow, 1, (1.0 /*_SSIgnoreCastedShadows*/));
				#endif
				...
				for (int index = 0; index < 4; index++)
				{
					...
					if ((0.0 /*_Is_SpecularToHighColor*/))
					{
						vSpecMask = pow(specArea, exp2(lerp(11, 1, (0.234 /*_HighColor_Power*/)))) * (1.0 /*_Layer1Strength*/) * poiLight.vAttenuation * poiLight.vColor[index];
					...
					{
						vSpecMask = poiEdgeNonLinear(specArea, (1.0 - pow((0.234 /*_HighColor_Power*/), 5)), (0.0 /*_StylizedSpecularFeather*/)) * (1.0 /*_Layer1Strength*/) * poiLight.vAttenuation * poiLight.vColor[index];
